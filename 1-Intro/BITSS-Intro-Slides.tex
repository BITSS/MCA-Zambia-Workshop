...
\item Subscribe to the BITSS blog \& E-mail list
\item Apply for our Summer Institute.
\item Apply for our SSMART Grant (extra funding for developing country researchers).
\end{itemize}
\end{frame}
